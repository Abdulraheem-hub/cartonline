<div class="col-sm-8">
    <section class="contact-form">
        <form action="{$urls.pages.contact}" method="post" class="contact-form-box"
              {if $contact.allow_file_upload}enctype="multipart/form-data"{/if}><!-- added class="contact-form-box" by skt-->
          ...
          >{if $contact.message}{$contact.message}{/if}</textarea>
            ...
            <footer class="form-footer text-right submit"><!--added submit by skt-->
                <style>
                    input[name=url] {
                ...
                <input class="btn btn-primary" type="submit" name="submitMessage" id="submitMessage"
                      value="{l s='Send' d='Shop.Theme.Actions'}"><!--added id="submitMessage" by skt-->
            </footer>
        </form>
    </section>
</div>
