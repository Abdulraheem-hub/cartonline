        ...
        <div class="div_gdpr_buttons">
            <a class="btn btn-primary data-request"
			  ...
			  <span class="link-item">
				<!--commented by skt <i class="material-icons">insert_drive_file</i>-->
            ...
            <a class="btn btn-primary"
			  ...
			  <span class="link-item">
				<!--commented by skt<i class="material-icons">assignment_returned</i>-->
				<i class="fa fa-download"></i><!--added by skt-->
