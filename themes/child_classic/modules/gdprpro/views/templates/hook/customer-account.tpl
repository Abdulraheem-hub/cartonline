...
{if (GdprPro::isPs17())}
    <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12 data-request"
      ...
      <span class="link-item">
	  	<!--commented by skt <i class="material-icons">delete</i>-->
        <i class="fa fa-trash"></i><!--added by skt-->
    ...
    <a class="col-lg-4 col-md-6 col-sm-6 col-xs-12 data-request"
      ...
      <span class="link-item">
	  	<!--commented by skt <i class="material-icons"><i class="material-icons">assignment_returned</i></i>-->
        <i class="fa fa-reply"></i><!--added by skt-->
