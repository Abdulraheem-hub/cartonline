 ...
 *}
    ...
    <div class="product-prices">
                ...
                {if $product.show_availability && $product.availability_message}
                  ...
                  {if $product.availability == 'available'}
                      <i class="fa fa-check rtl-no-flip" aria-hidden="true"></i>
										...
										<!--added by skt-->
										{if Context::getContext()->customer->isLogged()} : {$product.quantity} {/if}
										<!--ended by skt-->			 
		...
		<!--added by skt to display button when no login-->
		{else}
		<a class="btn btn-primary" href="?controller=authentication">Login to view Price</a>
		<!--ended by skt-->
        {/if}
