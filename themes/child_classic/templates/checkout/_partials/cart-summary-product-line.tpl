...
{block name='cart_summary_product_line'}
  ...
  <div class="media-body align-self-center">
    ...
    {/foreach}
	  <!--text-mited class removed by skt from product quantity span-->
    <span class="pull-right"><span class="product-quantity">x{$product.quantity}</span> {$product.price}</span>
